    ...
    function Input(props) {
      ...
      _this.newVat = function (event) {
        if (typeof event.target.value === 'number' || typeof event.target.value === 'string') {
          ...
          _this.setState({ error: 'Proszę wprowadzić poprawny format NIP' });
        }
      };
      ...
      _this.keyPress = function (event) {
        if (event.key === 'Enter') {
          if (_this.state.value.length < 9) {
            _this.setState({ error: 'Proszę wprowadzić poprawny numer' });
          } else if (_this.state.value.length >= 9) {
      ...
      _this.checkStorage = function () {
        if (_this.storageAvailable('localStorage')) {
          var keyString = JSON.stringify(_this.state.value);
    ...
    _createClass(Input, [{
      ...
      value: function render() {
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement('input', { value: this.state.value, placeholder: 'wprowad\u017A numer NIP i naci\u015Bnij ENTER', type: 'text', onChange: this.newVat, onKeyPress: this.keyPress }),
          _react2.default.createElement(
            'div',
            { className: 'error' },
            this.state.error
